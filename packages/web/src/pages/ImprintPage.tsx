    ...
    <div className="max-w-3xl mx-auto px-6 py-20 font-sans text-charcoal-light leading-relaxed">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-1 text-lg text-charcoal">
          <p>
            <ObfuscatedContact reversedValue="nielreböK sualokiN" />
          </p>
          <p>
            <ObfuscatedContact reversedValue="ynamreG ,trufteiD 54329 ,81 nebargtdatS" />
          </p>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-1 text-lg text-charcoal font-medium">
          <p>
            Email: <ObfuscatedContact reversedValue="ed.nielrebeokn@musserpmi" isEmail={true} />
          </p>
        </div>
      </section>
